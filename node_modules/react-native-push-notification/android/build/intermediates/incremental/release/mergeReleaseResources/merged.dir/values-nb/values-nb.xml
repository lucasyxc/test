...
<resources xmlns:ns1="urn:oasis:names:tc:xliff:document:1.2">
    ...
    <string gender="unknown" name="alert_description">Varsel</string>
    <string gender="unknown" name="catalyst_dev_menu_header">React Native-utviklermenyen (%1$s)</string>
    <string gender="unknown" name="catalyst_dev_menu_sub_header">Kjører %1$s</string>
    <string gender="unknown" name="combobox_description">Kombinasjonsboks</string>
    ...
    <string msgid="4133737464567140336" name="fcm_fallback_notification_channel_label">"Diverse"</string>
    <string gender="unknown" name="header_description">Overskrift</string>
    <string gender="unknown" name="image_description">Bilde</string>
    <string gender="unknown" name="imagebutton_description">Knapp, bilde</string>
    <string gender="unknown" name="link_description">Lenke</string>
    <string gender="unknown" name="menu_description">Meny</string>
    <string gender="unknown" name="menubar_description">Menyfelt</string>
    <string gender="unknown" name="menuitem_description">Menyelement</string>
    <string gender="unknown" name="progressbar_description">Fremdriftslinje</string>
    ...
    <string gender="unknown" name="spinbutton_description">Rotasjonsknapp</string>
    <string gender="unknown" name="state_busy_description">opptatt</string>
    <string gender="unknown" name="state_collapsed_description">skjult</string>
    <string gender="unknown" name="state_expanded_description">utvidet</string>
    ...
    <string gender="unknown" name="state_unselected_description">valgt bort</string>
    <string msgid="6277540029070332960" name="status_bar_notification_info_overflow">"999+"</string>
    <string gender="unknown" name="summary_description">Sammendrag</string>
    <string gender="unknown" name="tablist_description">Faneliste</string>
    <string gender="unknown" name="timer_description">Tidsur</string>
    <string gender="unknown" name="toolbar_description">Verktøylinje</string>
</resources>